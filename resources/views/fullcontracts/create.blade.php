...
<div id="app" class="page-wrapper">
    <main class="page-content">
        ...
        <div class="page-inner">
            ...
            <form method="POST" action="{{url('fullcontracts')}}" class="form-vertical validated sximo-form"
                id="FormTable" enctype="multipart/form-data">
                @csrf
                <div class="toolbar-nav">
                    <div class="row">
                        <div class="col-md-6 ">
                            <div class="submitted-button">
                                <button name="apply" class="tips btn btn-sm   " title="Back"><i
                                        class="fa  fa-check"></i> Apply Change(s) </button>
                                <button name="save" class="tips btn btn-sm " id="saved-button" title="Back"><i
                                        class="fa  fa-paste"></i> Save </button>
                            </div>
                        </div>
                        <div class="col-md-6 text-right ">
                            <a href="{{url('fullcontracts')}}" class="tips btn   btn-sm " title="Back"><i
                        ...
                        <div id="wizard-step" class="wizard-circle number-tab-steps">
                            ...
                            <section>
                                ...
                                <div class="form-group  ">
                                    ...
                                    <input type='text' name='contract_label' id='contract_label' value='' required
                                        class='form-control' />
                                </div>
                                ...
                                <div class="form-group  ">
                                    ...
                                    <input type="checkbox" class="radio_check" value="1" checked="checked"
                                        name='first_party_select' /> Yes
                                ...
                                <div class="form-group  ">
                                    ...
                                    <input type="checkbox" class="radio_check" checked="checked" value="1"
                                        name='copies' /> 1 Copy
                                ...
                                <div class="form-group  ">
                                    ...
                                    <input type='text' name='pages' id='pages' value='' required
                            ...
                            <section>
                                <div class="form-group  ">
                                    ...
                                    <select name='service_type_id' rows='5' id='service_type_id' class='select2 '
                                        required>
                                        <option value="">-- Please Select --</option>
                                ...
                                <div class="form-group  ">
                                    ...
                                    <select name='second_party_type_id' rows='5' id='second_party_type_cli'
                                        class="form-control" required>
                                        <option value="">-- Please Select --</option>
                            ...
                            <section>
                                ...
                                <div class="form-group  ">
                                    ...
                                    <select name='contract_duration_id' rows='5' id='contract_duration'
                                        class="form-control" required>
                                        <option value="">-- Please Select --</option>
                                ...
                                <div class="form-group  ">
                                    ...
                                    <textarea name='contract_notes' rows='5' id='contract_notes'
                            ...
                            <section>
                                ...
                                <div class="form-group select_contract_type_draft">
                                    ...
                                    <div class="contract_pdf-preview preview-upload">
                                        <img src='http://localhost/contracts/uploads/images/no-image.png' border='0'
                                            width='80' class='img-circle' /></a>
                                    </div>
                                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button id="close-add-modal" type="button" class="btn btn-secondary"
                    data-dismiss="add-modal">Close</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button id="edit-item" onclick="editItem($(this).data('id'))" type="button" class="btn btn-primary">Save
                    changes</button>
                <button id="close-edit-modal" type="button" class="btn btn-secondary"
                    data-dismiss="edit-modal">Close</button>
            </div>
        </div>
    </div>
</div>

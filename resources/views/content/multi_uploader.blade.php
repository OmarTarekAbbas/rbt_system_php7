          ...
          <form name="form_id" id="form_id" class="form-horizontal" action="javascript:void(0);" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                ...
                <button type="button" onclick="location.href='{{url('contents/upload_tracks')}}' " class="btn btn-danger btn-sm "><i class="fa  fa-arrow-circle-left "></i>Cancel</button>
              </div>
    ...
    <script type='text/javascript'>
        $(document).ready(function()
        {
            ...
            ({
                ...
                autoSubmit: true,
                vpb_server_url: "{{url('contents/save_tracks')}}"
            });
        });
    </script>
    <script type="text/javascript">

    ...
    <div class="col-md-12">
      <div class="box">
        ...
        <div class="box-content">
          ...
          <form action="{{url('ContractTemplate')}}" method="post" class="width_m_auto form-horizontal form-bordered form-row-stripped" enctype="multipart/form-data" novalidate>
            {!! csrf_field() !!}
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9 col-lg-10 controls">
                {!! Form::select('content_type',[ 1 => 'IN', 2 => 'OUT' ],null,['class'=>'form-control chosen-rtl btn-lg','required' => true,'style'=>'height: 48px;']) !!}
              </div>
            </div>
...
<script>
  ...
  $('#ContractTemplate-create').addClass('active');
</script>
@stop

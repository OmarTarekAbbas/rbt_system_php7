  ...
  <div class="col-md-12">
    <div class="box">
      ...
      <div class="box-content">
        <form class="width_m_auto form-horizontal" action="{{url('roles')}}" method="post">
          {{ csrf_field() }}
          <div class="form-group">
            ...
            <div class="col-sm-9 col-lg-10 controls">
              ...
              <input type="text" name="name" placeholder="Role Name" class="form-control input-lg" required>

            ...
            <div class="form-group">
              ...
              <div class="col-sm-9 col-lg-10 controls">
                <select class="form-control" data-placeholder="Choose a year" name="year" tabindex="1" required>
                  @for($year = date('Y')-5 ; $year <= date('Y')+5 ; $year++) <option value="{{$year}}" {{$year == $revenue->year ? 'selected' : ''}}>{{$year}}</option>
                    @endfor
                </select>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9 col-lg-10 controls">
                <select class="form-control" data-placeholder="Choose a month" name="month" tabindex="1" required>
                  @for($month = 1 ; $month <= 12 ; $month++) <option value="{{date("F", strtotime("$month/1/1"))}}" {{date("F", strtotime("$month/1/1")) == $revenue->month ? 'selected' : ''}}>{{date("F", strtotime("$month/1/1"))}}</option>
                    @endfor
                </select>

    ...
    <div class="box box-black">
      ...
      <div class="box-content">
        ...
        <div class="btn-toolbar pull-right clearfix">
          <div class="btn-group">
            <a class="btn btn-success show-tooltip" title="Add" href="{{url('revenue/create')}}"><i
                class="fa fa-plus"></i> Add Revenue</a>
          </div>
        </div>
        <br /><br />
          ...
          <table id="example" class="table table-striped dt-responsive" cellspacing="0" width="100%">
            ...
            <tbody>
              ...
              <tr class="table-flag-blue">
                <td>{{$revenue->id}}</td>
                <td>{{optional($revenue->contract)->contract_code}}<span
                    class="btn btn-sm">{{optional($revenue->contract)->contract_label}}</span></td>
                <td>{{$revenue->year}}</td>
                <td>{{$revenue->month}}</td>
                ...
                <td class="visible-md visible-lg">
                  <div class="btn-group">
                    ...
                    <a class="btn btn-sm btn-primary show-tooltip" title="" href="{{url('revenue/'.$revenue->id)}}"
                      data-original-title="view"><i class="fa fa-eye"></i></a>
                    @endif

                    @if (get_action_icons('revenue/{revenue}/edit', 'get'))
                    <a class="btn btn-sm show-tooltip" title="" href="{{url('revenue/'.$revenue->id.'/edit')}}"
                    ...
                    <a class="btn btn-sm btn-danger show-tooltip" title=""
                      ...
                      href="{{url('revenue/'.$revenue->id.'/delete')}}" data-original-title="Delete"><i

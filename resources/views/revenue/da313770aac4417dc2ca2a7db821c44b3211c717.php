                        ...
                        <div class="col-sm-9 col-lg-10 controls">
                            <select class="form-control chosen" data-placeholder="Choose an operator" name="operator" id="operator" tabindex="1" onchange="fun(this)">
                                ...
                                <?php $__currentLoopData = $operators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $operator): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($operator->id); ?>"><?php echo e($operator->title); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div><br><br>
        ...
        function get_statistics() {
            ...
            $.ajax({
                ...
                success:function (result) {
                    ...
                    {
                        nodes[i] = {y:parseFloat(result[i].revenue_share),label:result[i].rbt_name+"/"+result[i].title+"/"+result[i].year+"-"+result[i].month} ;
                    }

            ...
            <div class="box">
                ...
                <div class="box-content">
                    <form class="form-horizontal" action="<?php echo e(url('users')); ?>" method="post">
                      ...
                      <?php if(isset($_REQUEST['aggregator_id'])): ?>
                      <div class="form-group">
                            <label class="col-sm-3 col-lg-2 control-label">Name *</label>
                            <div class="col-sm-9 col-lg-10 controls">
                                
                                <input type="text" name="name" placeholder="User Name" class="form-control input-lg" value="<?php echo e($_REQUEST['title']); ?>" readonly required>
                        ...
                        <div class="form-group">
                              ...
                              <div class="col-sm-9 col-lg-10 controls">
                                <select class="form-control input-lg" name="aggregator_id">
                                  <option value="<?php echo e($_REQUEST['aggregator_id']); ?>" selected><?php echo e($_REQUEST['title']); ?></option>
                                </select>
                              </div>
                          </div>
                        <?php endif; ?>

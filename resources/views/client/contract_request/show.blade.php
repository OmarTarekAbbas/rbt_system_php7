...
<div class="row marginZero">
  <div class="col-md-4 noPaddingPhone" style="text-align: center;">
    <a class="btn btn-circle btn-primary show-tooltip " href="{{url('client/contractrequests')}}" title="List contractRequests">
      <i class="fa fa-eye"></i>
    </a>
    <a href="{{url('client/contractrequests')}}" title="List contractRequests">

            ...
            <table id="" class="table table-striped dt-responsive data_attachment" cellspacing="0" width="100%">
              ...
              <tbody>
                <tr>
                  ...
                  <td><a href="{{url('client/contracts/'.optional($Attachment->contract)->id)}}">{{optional($Attachment->contract)->contract_code}} - {{optional($Attachment->contract)->contract_label}}</a></td>

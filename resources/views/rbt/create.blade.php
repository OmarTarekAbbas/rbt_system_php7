                    ...
                    <form method = 'POST' class="form-horizontal" action = '{!!url("rbt")!!}' enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 col-lg-2 control-label"  for="code">Code *</label>
                             <div class="col-sm-9 col-lg-10 controls">   
                            <input id="code" name = "code" type="number" class="form-control input-lg" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 col-lg-2 control-label"  for="social_media_code">Social Media Code</label>
                             <div class="col-sm-9 col-lg-10 controls">   
                            <input id="social_media_code" name = "social_media_code" type="number" class="form-control input-lg">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 col-lg-2 control-label"  for="owner">Owner</label>
                             <div class="col-sm-9 col-lg-10 controls">   
                            <input id="owner" name = "owner" type="text" class="form-control input-lg">
                            </div>
                        </div>
                        <div class="form-group">

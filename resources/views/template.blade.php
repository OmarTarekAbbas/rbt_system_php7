      ...
      <ul class="nav nav-list">
        ...
        <li id="contract">
          ...
          <ul class="submenu">
            ...
            <li id="contract-fullcontracts_expiry_date"><a href="{{url('fullcontracts_expiry_date')}}">Contracts Expiry Date</a></li>
            @endif
        ...
        <li id="Attachment">
          ...
          <ul class="submenu">
            ...
            <li id="Attachment-attachment_expiry_date"><a href="{{url('attachment_expiry_date')}}">Attachment Expiry Date</a></li>
            @endif
          </ul>
          <!-- END Submenu -->
        </li>

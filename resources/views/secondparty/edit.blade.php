                ...
                <div class="box box-red">
                  ...
                  <div class="box-content">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-xs-12 col-lg-10 controls">
                        <input type="text" name="email" id="email" value="{{ $SecondParty->email }}" placeholder="Email" class="form-control">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <label for="image" class="col-xs-12 col-lg-2 control-label"> Image </label>
                      <div class="col-xs-12 col-lg-10 controls">
                        <div class="col-md-12">
                          <img src="{{ $SecondParty->image }}" width="100px" height="100px" alt="">
                        </div>

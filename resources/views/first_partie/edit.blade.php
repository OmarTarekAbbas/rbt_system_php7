        ...
        <div class="row">
          <div class="col-md-12">
            <form class="width_m_auto form-horizontal" action="{{route('admin.firstparties.update',['firstpartie' => $firstpartie])}}" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label for="first_party_joining_date" class="col-xs-12 col-lg-2 control-label">
                  Joining date</label>
              ...
              <div class="form-group">
                <label class="col-xs-12 col-lg-2 control-label" for="code"> Signature </label>
                <div class="col-xs-12 col-lg-10 controls">
              ...
              <div class="form-group">
                <label class="col-xs-12 col-lg-2 control-label" for="code"> Seal </label>
                <div class="col-xs-12 col-lg-10 controls">
                  <div class="fileUpload">

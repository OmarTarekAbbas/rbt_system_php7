                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <form class="form-horizontal"
                            action="{{route('admin.firstparties.update',['firstpartie' => $firstpartie])}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-lg-10 controls">
                                    ...
                                    <input type="text" name="first_party_title" placeholder="FirstPartie Title"
                                        class="form-control input-lg" value="{{$firstpartie->first_party_title}}"
                                        required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date date-picker col-sm-9 col-lg-10 controls"
                                    ...
                                    <input type="text" name="first_party_joining_date" id="first_party_joining_date"
                                        autocomplete="off" placeholder="first party joining date"
                                        value="{{$firstpartie->first_party_joining_date->format('d-m-Y')}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-lg-10 controls">
                                    <div class=" col-md-6 fileUpload">
                                        <input type="file" name="first_party_signature" id="first_party_signature"
                                            placeholder="Second Party Title" class="form-control">
                                    </div>
                                    @if($firstpartie->first_party_signature)
                                    <a class="btn btn-sm btn-success"
                                        href="{{ url($firstpartie->first_party_signature) }}" target="_blank">Review</a>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-lg-10 controls">
                                    <div class=" col-md-6 fileUpload">
                                        <input type="file" name="first_party_seal" id="first_party_seal"
                                            placeholder="Second Party Title" class="form-control">
                                    </div>

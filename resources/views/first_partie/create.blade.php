          ...
          <div class="col-md-12">
            <form class="width_m_auto form-horizontal" action="{{url('firstparties')}}" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label class="col-xs-12 col-lg-2 control-label">Title *</label>
              ...
              <div class="form-group">
                <label for="first_party_joining_date" class="col-xs-12 col-lg-2 control-label"> first party joining date</label>
              ...
              <div class="form-group">
                <label for="second_party_tc" class="col-xs-12 col-lg-2 control-label"> First party signature </label>
                <div class="col-xs-12 col-lg-10 controls">
              ...
              <div class="form-group">
                <label for="second_party_tc" class="col-xs-12 col-lg-2 control-label"> First party seal </label>
                <div class="col-xs-12 col-lg-10 controls">

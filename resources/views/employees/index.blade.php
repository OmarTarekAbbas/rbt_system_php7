                ...
                <tr class="table-flag-blue">
                  ...
                  <td class="visible-xs visible-md visible-lg">
                    <div class="btn-group">
                      ...
                      <a class="btn btn-sm show-tooltip" title="" href="{{url('employees/'.$employee->id.'/edit')}}" data-original-title="Edit">
                        <i class="fa fa-edit"></i>
                      </a>
                      @endif
                      @if(get_action_icons('employees/{id}/contracts','get'))
                      <a class="btn btn-sm btn-success show-tooltip" title="Add Employee Contracts" href="{{url('employees/'.$employee->id.'/contracts')}}" data-original-title="Add Employee Contracts">
                        <i class="fa fa-plus"></i>
                      </a>
                      @endif
                      @if(get_action_icons('employees/{employee}','get'))
                      <a class="btn btn-sm btn-primary show-tooltip" title="Show" href="{{url('employees/'.$employee->id)}}" data-original-title="Add Employee Contracts">
                        <i class="fa fa-eye"></i>
                      </a>
                      @endif
                      @if(get_action_icons('employees/{id}/delete','get'))
                      <a class="btn btn-sm btn-danger show-tooltip" title="" onclick="return confirm('Are you sure you want to delete this ?');" href="{{url('employees/'.$employee->id.'/delete')}}" data-original-title="Delete">

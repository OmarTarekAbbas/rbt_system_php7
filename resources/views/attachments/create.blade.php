    ...
    <div class="col-md-12 noPaddingPhone">
      <div class="box">
        ...
        <div class="box-content">
          ...
          <form action="{{url('attachment')}}" method="post" class="width_m_auto form-horizontal form-bordered form-row-stripped" enctype="multipart/form-data" novalidate>
            @csrf
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9 col-lg-10 controls">
                <input type="text" name="attachment_title" id="attachment_title" placeholder="Title" class="form-control" required>
              </div>
            </div>

              ...
              <div class="box box-red">
                ...
                <div class="box-content">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9 col-lg-10 controls">
                      <input type="text" value="{{$roadmap->event_color}}" name="event_color" id="event_color" placeholder="Event Color" class="form-control colorpicker-default">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group date date-picker col-sm-9 col-lg-10 controls" data-date-format="dd-mm-yyyy" style="width: 78%; margin: 0 auto;">
                      ...
                      <input type="text" value="{{$roadmap->event_start_date->format('d-m-Y')}}" name="event_start_date" id="event_start_date" placeholder="Event Start Date" data-date-format="dd-mm-yyyy" class="form-control">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group date date-picker col-sm-9 col-lg-10 controls" data-date-format="dd-mm-yyyy" style="width: 78%; margin: 0 auto;">
                      <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                      <input type="text" value="{{$roadmap->event_end_date->format('d-m-Y')}}" name="event_end_date" id="event_end_date" placeholder="Event End Date" data-date-format="dd-mm-yyyy" class="form-control">
                    </div>
                  </div>
                </div>
              </div>

            ...
            <div class="row">
                ...
                <div class="box box-red">
                  ...
                  <div class="box-content">
                    <div class="form-group">
                      <label for="event_title" class="col-xs-12 col-lg-2 control-label"> Event Title</label>
                    ...
                    <div class="form-group">
                      <label for="event_color" class="col-xs-12 col-lg-2 control-label"> Event Color</label>
                      <div class="col-xs-12 col-lg-10 control">
                    ...
                    <div class="form-group">
                      <label for="event_start_date" class="col-xs-12 col-lg-2 control-label"> Event Start Date</label>
                      <div class="input-group date date-picker col-xs-12 col-lg-10 controls event_start_date" data-date="12-02-2012" data-date-format="dd-mm-yyyy" style="width: 81.25%; margin: 0 auto;">
                    ...
                    <div class="form-group">
                      <label for="event_end_date" class="col-xs-12 col-lg-2 control-label"> Event End Date</label>
                      <div class="input-group date date-picker col-xs-12 col-lg-10 controls event_end_date" data-date="12-02-2012" data-date-format="dd-mm-yyyy" style="width: 81.25%; margin: 0 auto;">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
              ...
              <div class="col-md-12" style="float: none; margin: 0 auto;">
                <div class="box box-red">
                  ...
                  <div class="box-content">
                    <div class="form-group">
                      <label for="country_id" class="col-xs-12 col-lg-2 control-label">Country</label>
                      <div class="col-xs-12 col-lg-10 controls">
                    ...
                    <div class="form-group">
                      <label for="occasion_id" class="col-xs-12 col-lg-2 control-label">Occasion</label>
                      <div class="col-xs-12 col-lg-10 controls">
                    ...
                    <div class="form-group">
                      <label for="aggregator_id" class="col-xs-12 col-lg-2 control-label">Aggregators</label>
                      <div class="col-xs-12 col-lg-10 controls">
                    ...
                    <div class="form-group">
                      <label for="operator_id" class="col-xs-12 col-lg-2 control-label">Operator</label>
                      <div class="col-xs-12 col-lg-10 controls">
              ...
              <div class="col-md-12" style="float: none; margin: 0 auto;">
                <div class="box box-red">
                  ...
                  <div class="box-content">
                    <div class="form-group">
                      <label for="aggregator_support" class="col-xs-12 col-lg-2 control-label">Aggregator Support</label>
                      <div class="col-xs-12 col-lg-10 controls">
                        <textarea name="aggregator_support" id="aggregator_support" rows="3" class="form-control">{{$roadmap->aggregator_support}}</textarea>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="operator_support" class="col-xs-12 col-lg-2 control-label">Operator Support</label>
                      <div class="col-xs-12 col-lg-10 controls">
                        <textarea name="operator_support" id="operator_support" rows="3" class="form-control">{{$roadmap->operator_support}}</textarea>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="promotion_support" class="col-xs-12 col-lg-2 control-label">Promotion Support</label>
                      <div class="col-xs-12 col-lg-10 controls">
            ...
            <div class="row append-row">
              ...
              <div class="col-md-12" style="float: none; margin: 0 auto;">
                <div class="box box-red">
                  ...
                  <div class="box-content">
                    <div class="form-group">
                      <label for="provider_id" class="col-xs-12 col-lg-2 control-label">Provider</label>
                      <div class="col-xs-12 col-lg-10 controls">
                    ...
                    <div class="form-group content">
                      <label for="content_id" class="col-xs-12 col-lg-2 control-label">Content</label>
                      <div class="col-xs-12 col-lg-10 controls">

              ...
              <div class="box box-red">
                ...
                <div class="box-content">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group date  event_start_date col-sm-9 col-lg-10 controls" style="width: 81.25%; margin: 0 auto;">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group date event_end_date col-sm-9 col-lg-10 controls" data-date-format="dd-mm-yyyy" style="width: 81.25%; margin: 0 auto;">
                      <span class="input-group-addon"><i class="fa fa-calendar"></i></span>

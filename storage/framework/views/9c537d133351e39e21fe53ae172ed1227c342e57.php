    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-content">
                <form class="form-horizontal" action="<?php echo e(url('roadmaps/'.$roadmap->id)); ?>" method="post">
                                ...
                                <div class="box-content">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-lg-10 controls">
                                            <input type="text" value="<?php echo e($roadmap->event_title); ?>" name="event_title" id="event_title"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-lg-10 controls">
                                            <input type="text" value="<?php echo e($roadmap->event_color); ?>" name="event_color" id="event_color"
                                                placeholder="Event Color" class="form-control colorpicker-default">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date date-picker col-sm-9 col-lg-10 controls" data-date="12-02-2012" data-date-format="dd-mm-yyyy" >
                                            ...
                                            <input type="text" value="<?php echo e($roadmap->event_start_date->format('d-m-Y')); ?>" name="event_start_date" id="event_start_date"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date date-picker col-sm-9 col-lg-10 controls" data-date="12-02-2012" data-date-format="dd-mm-yyyy" >
                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            <input type="text" value="<?php echo e($roadmap->event_end_date->format('d-m-Y')); ?>" name="event_end_date" id="event_end_date"
                            ...
                            <div class="box box-red">
                                ...
                                <div class="box-content">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-lg-10 controls">
                                            <?php echo Form::select('country_id',$countries,$roadmap->country_id,['class'=>'form-control chosen-rtl' , 'id' => 'country_id' ,'required' => true,'style'=>'height: 48px;']); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-lg-10 controls">
                                            <?php echo Form::select('occasion_id',[],$roadmap->occasion_id,['class'=>'form-control chosen-rtl' , 'id' => 'occasion_id' ,'required' => true,'style'=>'height: 48px;']); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-lg-10 controls">
                                            <?php echo Form::select('aggregator_id',$aggregators,$roadmap->aggregator_id,['class'=>'form-control chosen-rtl' , 'id' => 'aggregator_id' ,'required' => true,'style'=>'height: 48px;']); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-lg-10 controls">
                                            <?php echo Form::select('operator_id',[],$roadmap->operator_id,['class'=>'form-control chosen-rtl' , 'id' => 'operator_id' ,'required' => true,'style'=>'height: 48px;']); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-lg-10 controls">
                                            <textarea name="aggregator_support"  id="aggregator_support" rows="3"
                                                class="form-control"><?php echo e($roadmap->aggregator_support); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-lg-10 controls">
                                            <textarea name="operator_support" id="operator_support" rows="3"
                                                class="form-control"><?php echo e($roadmap->operator_support); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-lg-10 controls">
                                            <textarea name="promotion_support" id="promotion_support" rows="3"
                                                class="form-control"><?php echo e($roadmap->promotion_support); ?></textarea>
                                        </div>
                                    </div>
...
<script>
    ...
    function createOperaotrForm(operators) {
        ...
        Object.keys(operators).forEach(key => {
            selected = ''
            if(operators[key].id == parseInt('<?php echo e($roadmap->operator_id); ?>')) {
                console.log('ok');
                selected = 'selected'
            }
    ...
    function createOccasionForm(occasions) {
        ...
        Object.keys(occasions).forEach(key => {
            selected = ''
            if(occasions[key].id == parseInt('<?php echo e($roadmap->occasion_id); ?>')) {
                selected = 'selected'
            }
    ...
    function createContentForm(contents) {
        ...
        Object.keys(contents).forEach(key => {
            selected = ''
            if(contents[key].id == parseInt('<?php echo e($roadmap->content_id); ?>')) {
                selected = 'selected'
            }

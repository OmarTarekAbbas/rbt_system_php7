    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-content">
                <form class="form-horizontal" action="<?php echo e(url('roadmaps')); ?>" method="post">
                            ...
                            <div class="box box-red">
                                ...
                                <div class="box-content">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-lg-10 controls">
                                            <?php echo Form::select('occasion_id',[],null,['class'=>'form-control chosen-rtl' , 'id' => 'occasion_id' ,'required' => true,'style'=>'height: 48px;']); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-lg-10 controls">
                                            <?php echo Form::select('aggregator_id',$aggregators,null,['class'=>'form-control chosen-rtl' , 'id' => 'aggregator_id' ,'required' => true,'style'=>'height: 48px;']); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-lg-10 controls">
                                            <?php echo Form::select('operator_id',[],null,['class'=>'form-control chosen-rtl' , 'id' => 'operator_id' ,'required' => true,'style'=>'height: 48px;']); ?>

                    ...
                    <form method = 'POST' class="form-horizontal" action = '<?php echo url("rbt"); ?>/<?php echo $rbt->id; ?>/update' enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-lg-10 controls">
                                <input id="track_title_en" name = "artist_name_en" value="<?php echo e($rbt->artist_name_en); ?>" type="text" class="form-control input-lg" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-lg-10 controls">
                                <input id="track_title_en" name = "artist_name_ar" value="<?php echo e($rbt->artist_name_ar); ?>" type="text" class="form-control input-lg" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-lg-10 controls">
                                <input id="track_title_en" name = "track_title_ar" value="<?php echo e($rbt->track_title_ar); ?>" type="text" class="form-control input-lg" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-lg-10 controls">
                                <input id="track_title_en" name = "album_name" value="<?php echo e($rbt->album_name); ?>" type="text" class="form-control input-lg"  required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-lg-10 controls">
                                <input id="owner" name = "owner" type="text" value="<?php echo e($rbt->owner); ?>" class="form-control input-lg"  required>
                            </div>
                        </div>

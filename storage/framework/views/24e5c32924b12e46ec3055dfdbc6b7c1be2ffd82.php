            ...
            <div class="box">
                ...
                <div class="box-content col-md-12">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="col-sm-9 col-lg-10 controls">
                            <input id="input13" class="form-control date-picker"  id="dp1" size="16" type="text" name="search_field[]" />
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="col-sm-9 col-lg-10 controls">
                            <input id="input14" class="form-control date-picker"  id="dp1" size="16" type="text" name="search_field[]" />
                        </div>
                    </div>
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        function append_result(record) {
            ...
            var edit_path = '<?php echo e(url('report/')); ?>'+'/'+record.id+'/edit' ;
            var delete_path = '<?php echo e(url('report/')); ?>'+'/'+record.id+'/delete' ;

                    ...
                    <form name="form_id" id="form_id" class="form-horizontal" action="javascript:void(0);" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                            ...
                            <!--<button type="submit" name="apply" class="btn btn-info btn-sm" ><i class="fa  fa-check-circle"></i> <?php echo e(Lang::get('core.sb_apply')); ?></button>-->
                                ...
                                <button type="button" onclick="location.href='<?php echo e(url('rbt/upload_tracks')); ?>' " class="btn btn-danger btn-sm "><i class="fa  fa-arrow-circle-left "></i>Cancel</button>
                            </div>
    ...
    <script type='text/javascript'>
        $(document).ready(function()
        {
            ...
            ({
                ...
                autoSubmit: true,
                vpb_server_url: "<?php echo e(url('rbt/save_tracks')); ?>"
            });
        });
    </script>
    <script type="text/javascript">

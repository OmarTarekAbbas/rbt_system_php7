...
class InsertRouteClientPayments extends Migration
{
    ...
    public function up()
    {
      ...
      \DB::statement("INSERT INTO `routes` (`id`, `method`, `route`, `controller_name`, `function_name`, `route_name`, `created_at`, `updated_at`) VALUES (NULL, 'post', 'clientpayments/{id}', 'ClientPaymentController', 'update', NULL, '2020-11-17 14:40:03', '2020-11-17 14:40:03')");
    }
